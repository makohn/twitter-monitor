...
public class TweetDao {
	...
	public List<Tweet> getTweets() {
		...
		return jdbc.query("select text from tweets", new RowMapper<Tweet>() {
	...
	public boolean insert(Tweet tweet) {
		...
		// return jdbc.update("insert into tweets (tweet_id, autor_id, text)
		// values (:tweetId, :authorId, :text)",
		// params) == 1;

		return jdbc.update("insert into test (text) values (:text)", params) == 1;
	}
}

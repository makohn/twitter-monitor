...
function slide_menu(){
    ...
    if(count_slide_menu%2 != 0)    
        ...
        setTimeout(function() {
            ...
            $('#change_sidebar_west_button').css(' background-image','url(changeContextBirdLeft.png)');
        ...
        $('#button_3').css('display', 'none');
         ...
         setTimeout(function(){
           ...
           setTimeout(function() {
            $('#change_sidebar_west_button').css('display','block');
            $('#change_sidebar_west_button').addClass('animated zoomIn'); 
            $('#change_sidebar_west_button').css(' background-image','url(changeContextBirdRight.png)');
        },700);
